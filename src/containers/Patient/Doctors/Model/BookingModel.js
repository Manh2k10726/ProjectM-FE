...
class BookingModel extends Component {
  ...
  handleConfirmBooking = async () => {
    ...
    if (res && res.errCode === 0) {
      ...
      toast.success(
        "Booking a new appointment succeed !!!Check your email to complete the procedure ! "
      );
            ...
            <div className="booking-modal-body">
              ...
              <div className="row">
                <div className="col-6 form-group">
                  <label>
                    <FormattedMessage id="patient.name" /> :
                  </label>
                  <input
                ...
                <div className="col-6 form-group">
                  <label>
                    <FormattedMessage id="patient.phone-number" /> :
                  </label>
                  <input
                    className="form-control"
                ...
                <div className="col-6 form-group">
                  <label>
                    <FormattedMessage id="patient.birthday" />:
                  </label>
                  <DatePicker
