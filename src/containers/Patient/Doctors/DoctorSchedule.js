...
class DoctorSchedule extends Component {
  ...
  async componentDidMount() {
    ...
    if (this.props.doctorIdFromDetailDoctor) {
      ...
      let res = await ScheduleDoctorByDate(
        this.props.doctorIdFromDetailDoctor,
        allDays[0].value
      );
      this.setState({
  ...
  async componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (
      this.props.doctorIdFromDetailDoctor !== prevProps.doctorIdFromDetailDoctor
    ) {
      let allDays = this.getArrDays(this.props.language);
      let res = await ScheduleDoctorByDate(
        this.props.doctorIdFromDetailDoctor,
  ...
  handleOnChangeSelect = async (event) => {
    if (
      this.props.doctorIdFromDetailDoctor &&
      this.props.doctorIdFromDetailDoctor != -1
    ) {
        ...
        <div className="doctor-schedule-container">
          ...
          <div className="all-available-time">
            <div className="text-calendar">
              ...
              <span>
                <FormattedMessage id="doctor-schedule.Examination-Schedule" /> :{" "}
              </span>
            </div>
                ...
                <>
                  ...
                  <div className="free">
                    <span>
                      ...
                      <FormattedMessage id="doctor-schedule.free" />{" "}
                    </span>
                  </div>
                </>
              ) : (
                <div>
                  <FormattedMessage id="doctor-schedule.success" />
                </div>
              )}
            </div>
          </div>
