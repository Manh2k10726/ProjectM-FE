...
class detailClinic extends Component {
    ...
    render() {
        ...
        console.log("check data clinic:",this.state.dataDetailClinic)
        return (
            <Fragment>
                <HomeHeader isShowBanner={false}/>
                <div className='specialty-detail-container'>
                    <div className='sp-detail-up'>
                        <div className='clinic-name'>{dataDetailClinic && !_.isEmpty(dataDetailClinic)
                                &&<div >
                                      {dataDetailClinic.name }
                                </div>
                            } 
                        </div>
                    <div className={checkHidden===false?'description-specialty-hidden':'description-specialty-show'}>
